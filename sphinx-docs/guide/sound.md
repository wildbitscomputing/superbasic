...
Depending on the hardware model and generation, a Wildbits machine includes a
...
There are four sound channels, numbered 0 to 3. Channels 0–2 are simple square
wave channels; channel 3 is a noise channel.
